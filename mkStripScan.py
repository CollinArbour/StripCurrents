...
for i  in range(3):
    ...
    ax = hp.mkScans(strips,p1,ax,f'Src{i+1:02}')

plt.title(f'MiniCSC4: Strip Scan L1 90Sr-allSrc H2 HV3600')
plt.legend()
plt.savefig(f'./plots/SrSrcs/allSrcs.png',format='png',dpi=400)
plt.close()
